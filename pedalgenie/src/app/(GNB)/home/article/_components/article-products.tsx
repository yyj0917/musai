...
export default function ArticleProducts() {
    ...
    return (
        <section className='pt-3 pb-10 w-full flex flex-col'>
            <h3 className='px-4 py-4 text-grey150 text-body1'>
                아티클에 나온 제품
            </h3>
                        ...
                        <div className='flex gap-3'>
                            ...
                            <span className='flex flex-col items-start gap-1'>
                                <p className='flex items-center gap-3 text-grey250 text-body1 '>
                                    ...
                                    <span
                                        onClick={handleRouteShop}><RightArrow/></span>
                                </p>
                                <p className='text-grey450 text- overflow-hidden line-clamp-1'>
                                    {product.name}
                                </p>
                                <p className='text-grey250 text-body1'>
                                    {product.price}
                                </p>
                            </span>
                        </div>
