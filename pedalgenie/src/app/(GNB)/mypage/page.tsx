    ...
    return (
        <div className="w-full h-auto flex flex-col ">
            ...
            <div className="relative w-full h-[82px] text-grey450">
                {!isUser ? (
                    ...
                    <div className="absolute left-4 top-[10.5px] flex flex-col gap-1">
                        ...
                        <p className="text-caption1 text-grey650">
            ...
            <div className="w-full h-[106px] flex">
                <Link href="/mypage/reservation" className="flex flex-col items-center justify-center w-1/2 gap-1 text-grey150 border-r-[0.5px] border-grey850">
                    <ReserveInfo />
