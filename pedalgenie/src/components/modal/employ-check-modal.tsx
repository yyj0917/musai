...
export default function EmplyCheckModal({status} : EmplyCheckModalProps) {
      ...
      <div
        ...
        <div className="flex flex-col justify-center items-center gap-6">
          ...
          <div className="w-full flex flex-col justify-center items-center gap-1">
            <button onClick={closeEmployCheckModal} className='w-full h-11 rounded text-center text-body1 text-grey150 bg-red'>
                네, 직원이 확인했어요
            </button>
